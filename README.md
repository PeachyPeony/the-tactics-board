...
- View formation layouts on an interactive football pitch
- Filter formations by type and tactical style
- Sort formations by: 
  - Name
  - Attacking rating
  - Defending rating
...
- Interactive formation cards with keyboard accessibility
...
## CSS 
CSS is used to create the visual design and responsive layout. 
The project includes: 
  - CSS custom properties for reusable design values
  - CSS Grid and Flexbox
  - Responsive media queries
  - Hover and focus states
  - CSS gradients
  - Custom football pitch layouts
  - Responsive formation player markers 
